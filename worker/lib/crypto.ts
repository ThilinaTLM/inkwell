// Crypto + ID/token helpers.
//
// Consolidated from the old worker/util.ts + worker/auth.ts. Everything
// in this file is environment-free: pure functions over Web Crypto.
